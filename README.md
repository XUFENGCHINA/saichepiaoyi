...
| 📱 **伪装手机系统** | Apos 液态星云 OS，粒子动画 + 锁屏 + 桌面 + 飞信 AI，老板来了秒切，以假乱真 |

---

## 📱 伪装手机系统里有什么

- **Apos OS** — 全屏仿手机界面，光纤粒子启动动画，锁屏拖动解锁
- **飞信 AI** — 内置 AI 聊天，支持 DeepSeek / OpenAI API，配好 Key 直接聊
- **桌面应用** — 时钟、商店、浏览器、自定义安装 HTML 应用
- **粒子壁纸** — 动态粒子背景，支持深色模式、自定义壁纸
